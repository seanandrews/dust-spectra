...
targ['FMTau']      = {'name': 'FMTau', 'label': 'FM Tau',
                      'vlabel': 'FM_Tau',
                      'X': {'X01_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s', '9s'], 
                                      'asolint': ['inf', '60s', '9s'],
                                      'sc_nt': 15.0, 'sc_lnt': 2.0,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['FPTau']      = {'name': 'FPTau', 'label': 'FP Tau',
                      ...
                      'X': {'X01_1': {'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'peel': False, 'selfcal': True,
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 5.0, 'sc_lnt': 2.0}},
...
targ['J04155799']  = {'name': 'J04155799', 'label': 'J04155799+2746175',
                      'vlabel': 'J04155799',
                      'X': {'X02_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1}},
...
targ['CYTau']      = {'name': 'CYTau', 'label': 'CY Tau',
                      'vlabel': 'CY_Tau',
                      'X': {'X02_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS', 
                                      'sc_nt': 10., 'sc_lnt': 2., 
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'nt': 10.0, 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 2}},
...
targ['V409Tau']    = {'name': 'V409Tau', 'label': 'V409 Tau',
                      'vlabel': 'V409_Tau',
                      'X': {'X03_1': {'peel': False, 'selfcal': False, 
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['V892Tau']    = {'name': 'V892Tau', 'label': 'V892 Tau',
                      'vlabel': 'V892_Tau',
                      'X': {'X03_1': {'peel': False,
                                      'selfcal': True, 'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['V807Tau']    = {'name': 'V807Tau', 'label': 'V807 Tau',
                      'vlabel': 'V807_Tau',
                      'X': {'X07_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 20., 'sc_lnt': 2.,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1}},
...
targ['IRAS04301']  = {'name': 'IRAS04301', 'label': 'IRAS 04301+2608',
                      'vlabel': 'IRAS_04301',
                      'X': {'X10_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 10., 'sc_lnt': 2.0, 
                                      'nt': 5., 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 3}},
...
targ['GI_GKTau']   = {'name': ['GITau', 'GKTau'],
                      'label': ['GI Tau', 'GK Tau'],
                      'vlabel': 'GK_Tau',
                      'X': {'X08_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['J04333905']  = {'name': 'J04333905', 'label': 'J04333905+2227207',
                      ...
                      'X': {'X07_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 8.0, 'sc_lnt': 2.0,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 3}},
...
targ['HOTau']      = {'name': 'HOTau', 'label': 'HO Tau',
                      'vlabel': 'HO_Tau',
                      'X': {'X07_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1}},
...
targ['IRAS04370']  = {'name': 'IRAS04370', 'label': 'IRAS 04370+2559',
                      'vlabel': 'IRAS_04370',
                      'X': {'X12_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 2}},
...
targ['GOTau']      = {'name': 'GOTau', 'label': 'GO Tau',
                      'vlabel': 'GO_Tau',
                      'X': {'X12_1': {'peel': False, 'peel_mode': 'PER-SPW',
                                      'peel_nt': 35.0, 'peel_lnt': 5.0, 
                                      'peel_selfcal': False, 'peel_pb': '0.12',
                                      'peel_psolint': [], 'peel_asolint': [],
                                      'peel_nterms': 2, 
                                      'selfcal': True, 'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s', '9s'], 
                                      'asolint': ['inf', '60s', '9s'],
                                      'sc_nt': 35.0, 'sc_lnt': 5.0, 
                                      'nt': 7.0, 'lnt': 2.0, 'imscl': 1.25,
                                      'nterms': 3}},
