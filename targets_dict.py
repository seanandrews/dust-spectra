...
targ['IRAS04125']  = {'name': 'IRAS04125', 'label': 'IRAS 04125+2902',
                      ...
                      'X': {'X01_1': {'nt': 5.0, 'lnt': 2.0, 'imscl': 1.5,
                                      ...
                                      'nterms': 3,
                                      'psolint': ['inf'], 'asolint': ['inf']},
                            'X15_1': {'nt': 5.0, 'lnt': 2.0, 'imscl': 1.5,
                                      'peel': False, 'selfcal': True,
                                      'nterms': 3,
                                      'psolint': ['inf'], 'asolint': ['inf']}},
...
targ['J04155799']  = {'name': 'J04155799', 'label': 'J04155799+2746175',
                      ...
                      'X': {'X02_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1},
                            'X02_2': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1}},
...
targ['V409Tau']    = {'name': 'V409Tau', 'label': 'V409 Tau',
                      ...
                      'X': {'X03_1': {'peel': False, 'selfcal': False, 
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X03_2': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X15_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['V892Tau']    = {'name': 'V892Tau', 'label': 'V892 Tau',
                      'vlabel': 'V892_Tau',
                      'X': {'X03_1': {'peel': False, 'selfcal': True, 
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X03_2': {'peel': False, 'selfcal': True, 
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['BPTau']      = {'name': 'BPTau', 'label': 'BP Tau',
                      'vlabel': 'BP_Tau',
                      'X': {'X04_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 5., 'sc_lnt': 2.0,
...
targ['J04202144']  = {'name': 'J04202144', 'label': 'J04202144+2813491',
                      ...
                      'X': {'X04_1': {'peel': False, 'selfcal': True,
                                      ...
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X16_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 5., 'sc_lnt': 2.0,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X16_2': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 5., 'sc_lnt': 2.0,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
...
targ['DETau']      = {'name': 'DETau', 'label': 'DE Tau',
                      'vlabel': 'DE_Tau',
                      'X': {'X04_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2},
                            'X16_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2},
                            'X16_2': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2}},
...
targ['UXTau']      = {'name': ['UXTauA', 'UXTauB', 'UXTauC'],
                      ...
                      'vlabel': 'UX_Tau_A',
                      'X': {'X05_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 10., 'sc_lnt': 2.0,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 3},
                            'X17_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 10., 'sc_lnt': 2.0,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 3,
...
targ['ZZTauIRS']   = {'name': 'ZZTauIRS', 'label': 'ZZ Tau IRS',
                      'vlabel': 'ZZ_Tau_IRS',
                      'X': {'X06_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 5., 'sc_lnt': 2.0,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
...
targ['MHO6']       = {'name': 'MHO6', 'label': 'MHO 6',
                      'vlabel': 'MHO_6',
                      'X': {'X05_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X17_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['GI_GKTau']   = {'name': ['GITau', 'GKTau'],
                      ...
                      'X': {'X08_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X09_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['J04334171']  = {'name': 'J04334171', 'label': 'J04334171+1750402',
                      ...
                      'X': {'X05_1': {'peel': False, 'selfcal': True,
                                      ...
                                      'asolint': ['inf', '60s', '9s'],
                                      'sc_nt': 25., 'sc_lnt': 2.0,
                                      'nt': 15., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 3},
                            'X06_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s', '9s'], 
                                      'asolint': ['inf', '60s', '9s'],
                                      'sc_nt': 25., 'sc_lnt': 2.0,
...
targ['J04334465']  = {'name': 'J04334465', 'label': 'J04334465+2615005',
                      'vlabel': 'J04334465',
                      'X': {'X09_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X16_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
...
targ['DMTau']      = {'name': 'DMTau', 'label': 'DM Tau',
                      'vlabel': 'DM_Tau',
                      'X': {'X06_1': {'peel': False, 'selfcal': False,
                                      'nt': 4., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X17_1': {'peel': False, 'selfcal': False,
                                      'nt': 4., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['HOTau']      = {'name': 'HOTau', 'label': 'HO Tau',
                      ...
                      'X': {'X07_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1},
                            'X07_2': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 1},
                            'X16_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
...
targ['DNTau']      = {'name': 'DNTau', 'label': 'DN Tau',
                      'vlabel': 'DN_Tau',
                      'X': {'X09_1': {'peel': False, 'selfcal': True,
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2}},
...
targ['IRAS04370']  = {'name': 'IRAS04370', 'label': 'IRAS 04370+2559',
                      ...
                      'X': {'X12_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 2},
                            'X12_2': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 2,
                                      'nterms': 2},
                            'X17_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 2,
...
targ['IRAS04385']  = {'name': 'IRAS04385', 'label': 'IRAS 04385+2550',
                      ...
                      'X': {'X12_1': {'peel': False, 'selfcal': False, 
                            ...
                            'X12_2': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2},
                            'X18_1': {'peel': False, 'selfcal': False,
                                      'nt': 5.0, 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2}},
...
targ['GOTau']      = {'name': 'GOTau', 'label': 'GO Tau',
                      'vlabel': 'GO_Tau',
                      'X': {'X12_1': {'peel': False, 'selfcal': True, 
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s', '9s'], 
                                      'asolint': ['inf', '60s', '9s'],
...
targ['IRAS04429']  = {'name': 'IRAS04429', 'label': 'IRAS 04429+1550',
                      'vlabel': 'IRAS_04429',
                      'X': {'X13_1': {'peel': False, 'selfcal': True, 
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s'], 
                                      'asolint': ['inf', '60s'],
                                      'sc_nt': 5.0, 'sc_lnt': 2.0,
...
targ['DQTau']      = {'name': 'DQTau', 'label': 'DQ Tau',
                      ...
                      'X': {'X13_1': {'peel': False, 'selfcal': True, 
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf'], 'asolint': ['inf'],
                                      'sc_nt': 10.0, 'sc_lnt': 2.0,
                                      'nt': 7.0, 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 2}},
...
targ['DSTau']      = {'name': 'DSTau', 'label': 'DS Tau',
                      'vlabel': 'DS_Tau',
                      'X': {'X14_1': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s', '9s'],
                                      'asolint': ['inf', '60s', '9s'],
                                      'sc_nt': 25., 'sc_lnt': 2.0,
                                      'nt': 10., 'lnt': 2.0, 'imscl': 3,
                                      'nterms': 3},
                            'X14_2': {'peel': False, 'selfcal': True,
                                      'selfcal_mode': 'MTMFS',
                                      'psolint': ['inf', '60s'],
                                      'asolint': ['inf', '60s'],
                                      'sc_nt': 25., 'sc_lnt': 2.0,
...
targ['CIDA8']      = {'name': 'CIDA8', 'label': 'CIDA 8',
                      'vlabel': 'CIDA_8',
                      'X': {'X14_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X14_2': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
                                      'nterms': 2},
                            'X18_1': {'peel': False, 'selfcal': False,
                                      'nt': 5., 'lnt': 2.0, 'imscl': 1,
